    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-center md:text-start">
        ...
        <motion.div
          ...
          className="flex flex-col gap-6 mt-20 text-4xl md:text-6xl font-bold text-white max-w-[600px] w-auto h-auto mx-auto md:mx-0"
        >
          <span>
            I&apos;m
        ...
        <motion.a
          ...
          className="py-2 button-primary text-center text-white cursor-pointer rounded-lg max-w-[200px] mx-auto md:mx-0 p-2"
        >
          Learn More!
        </motion.a>
      </div >
